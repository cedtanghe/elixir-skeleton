...
require_once dirname(__FILE__) . '/application/vendor/cedtanghe/elixir/src/framework/PHPChecker/Collection.php';
require_once dirname(__FILE__) . '/application/vendor/cedtanghe/elixir/src/framework/PHPChecker/Requirement.php';
require_once dirname(__FILE__) . '/application/vendor/cedtanghe/elixir/src/framework/PHPChecker/Factory.php';
